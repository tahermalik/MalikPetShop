...
import { addToCart, removerCartItem ,getCartItems, mergeCartItems} from "../controllers/cartController.js";
...
cartRouter.post("/mergeCartItems/:id",(req,res)=>mergeCartItems(req,res))
